...
import com.yboot.base.modules.social.vo.GithubUserInfo;
...
@RequestMapping("/base/social/github")
@Controller
public class GithubController {

    @Value("${base.social.github.clientId}")
    private String clientId;

    @Value("${base.social.github.clientSecret}")
    private String clientSecret;

    @Value("${base.social.github.callbackUrl}")
