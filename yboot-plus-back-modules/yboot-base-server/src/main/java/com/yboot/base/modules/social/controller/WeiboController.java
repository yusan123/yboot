...
import com.yboot.base.modules.social.vo.WeiboUserInfo;
...
@RequestMapping("/base/social/weibo")
@Controller
public class WeiboController {

    @Value("${base.social.weibo.appKey}")
    private String appKey;

    @Value("${base.social.weibo.appSecret}")
    private String appSecret;

    @Value("${base.social.weibo.callbackUrl}")
