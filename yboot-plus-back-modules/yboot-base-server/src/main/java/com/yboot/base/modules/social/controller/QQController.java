...
import com.yboot.base.modules.social.vo.QQUserInfo;
...
@RequestMapping("/base/social/qq")
@Controller
public class QQController {

    @Value("${base.social.qq.appId}")
    private String appId;

    @Value("${base.social.qq.appKey}")
    private String appKey;

    @Value("${base.social.qq.callbackUrl}")
