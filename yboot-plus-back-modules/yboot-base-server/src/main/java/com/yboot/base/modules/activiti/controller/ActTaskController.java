...
import com.yboot.base.modules.activiti.service.mybatis.IHistoryIdentityService;
import com.yboot.base.modules.activiti.service.mybatis.IRunIdentityService;
import com.yboot.base.modules.activiti.utils.MessageUtil;
import com.yboot.base.modules.activiti.vo.ActPage;
import com.yboot.base.modules.activiti.vo.Assignee;
import com.yboot.base.modules.activiti.vo.HistoricTaskVo;
import com.yboot.base.modules.activiti.vo.TaskVo;
    ...
    public Result<Object> historicFlow(@ApiParam("流程实例id") @PathVariable String id){
        ...
        taskList.forEach(e -> {
            ...
            if(StrUtil.isNotBlank(htv.getAssignee())){
                String assignee = userService.get(htv.getAssignee()).getUsername();
                String owner = userService.get(htv.getOwner()).getUsername();
