...
<template>
  <div class="access">
    <Row>
      <i-col :lg="24" :xl="8" style="padding:0 10px 10px 0">
        <Card>
          <p slot="title">
    ...
    <Row>
      <i-col :lg="24" :xl="14" style="padding:0 10px 10px 0">
        <Card>
          <p slot="title">
      ...
      <i-col :lg="24" :xl="10" style="padding:0 10px 10px 0">
        <Card>
          <p slot="title">
