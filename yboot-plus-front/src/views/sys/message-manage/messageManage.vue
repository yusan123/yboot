...
<template>
  <div class="search">
    <add-or-edit v-if="currView=='addOrEdit'" @close="currView='index'" :transferData="transferData" @submited="submited"/>
    <detail v-if="currView=='detail'" @close="currView='index'" :transferData="transferData"/>
...
import detail from "./messageSendDetail.vue";
import addOrEdit from "./addOrEditMessage.vue";
export default {
