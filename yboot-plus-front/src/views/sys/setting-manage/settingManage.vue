          ...
          <div style="display:flex;position:relative">
            <Form 
              ...
              <FormItem label="短信签名" prop="signName">
                <Input type="text" v-model="sms.signName" placeholder="请输入短信签名，例如YBoot" style="width: 350px"/>
              </FormItem>
            ...
            <Form 
              ...
              <FormItem label="应用部署域名" prop="domain">
                <Tooltip placement="right" content="拼接部分资源访问链接使用">
                  <Input type="text" v-model="other.domain" placeholder="请输入应用部署域名前缀，如http://yboot.canghaihongxin.cn" style="width: 350px"/>
                </Tooltip>
              </FormItem>
              <FormItem label="单点登录域名" prop="ssoDomain">
                <Tooltip max-width="250" transfer placement="right" content="该域名及子域名下将可获得单点登录所需数据">
                  <Input type="text" v-model="other.ssoDomain" placeholder="请输入应用部署一级域名，如canghaihongxin.cn" style="width: 350px"/>
                </Tooltip>
              </FormItem>
