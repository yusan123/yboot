...
export const authorizeRouter = {
    ...
    name: 'authorize',
    meta: {
        title: 'YBoot统一认证平台 - YBoot前后端分离开发平台 '
    },
...
export const otherRouter = {
    ...
    children: [
        ...
        { path: 'add', title: '添加', name: 'add', component: () => import('@/views/yboot-vue-template/new-window/add.vue') },
        { path: 'edit', title: '编辑', name: 'edit', component: () => import('@/views/yboot-vue-template/new-window/edit.vue') },
